#ifndef ZHKEYESIMCLIENT_UI_USERDATA_H_
#define ZHKEYESIMCLIENT_UI_USERDATA_H_
...
struct UserInfo {
    ...
    UserInfo(std::shared_ptr<SearchInfo> search_info):
        _uid(search_info->m_uid),_name(search_info->m_name),_nick(search_info->m_nick),
    _icon(search_info->m_icon),_sex(search_info->m_sex),_last_msg(""){
